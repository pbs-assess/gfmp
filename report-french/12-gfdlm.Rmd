...
Nous avons élaboré en R le progiciel [gfdlm] (https://github.com/pbs-assess/gfdlm) [@gfdlm] pour fournir un ensemble d’outils qui facilitent les applications de ce Cadre.
...
Cette version du document a été produite le `r Sys.time()` avec la version `r devtools::session_info()$platform$ [@r2019] et les versions du progiciel R :

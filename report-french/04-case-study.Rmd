...
1. LT LRP : Probabilité que *B* > 0,4*B*~MSY~ (années 35--50)
2. LT USR : Probabilité que *B* > 0,8*B*~MSY~ (années 35--50)
3. FMSY : P(*F* < *F*~MSY~) (années 1--50)
...
Nous avons appliqué des critères de satisfaction fondés sur le point de référence limite à long terme (LT LRP) et les paramètres de rendement des prises à court terme (STC) (LT LRP minimum > 0,9, STC minimum > 0,8). Nous avons écarté certaines procédures de gestion qui avaient un rendement presque identique pour avoir un groupe gérable de sept procédures de gestion pour poursuivre notre examen.

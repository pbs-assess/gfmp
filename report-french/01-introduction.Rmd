...
Depuis 2017, une entente de partenariat entre l’Université de la Colombie-Britannique (UBC) et le MPO [@dfo_dlmtool_2017] a facilité l’élaboration de deux progiciels à accès libre pour l’évaluation des stratégies de gestion, mis en œuvre dans R [@r2019] : la trousse Data Limited Methods toolkit (DLMtool) [@carruthers2018; @carruthers_hordyk_2018] et la trousse d’évaluation des stratégies de gestion (MSEtool) [[@huynh_msetool_2019]].
Après plusieurs années de développement, ces progiciels offrent certains des logiciels les plus rapides, les plus souples et les plus extensibles pour évaluer les stratégies de gestion pour les pêches, allant de systèmes pauvres en données à riches en données, permettant d’évaluer rapidement plusieurs procédures de gestion en fonction d’objectifs de conservation et de pêche personnalisables et d’évaluer les principaux compromis.
...
Un progiciel en R produit par les auteurs pour ce cadre, gfdlm [@gfdlm], contient de nombreux outils et des visualisations personnalisées pour faciliter le processus.

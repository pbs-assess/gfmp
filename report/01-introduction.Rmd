...
Although the proposed framework is software agnostic, in the current implementation, data and empirical analyses from the groundfish synopsis packages [@gfdata; @gfplot] are used to develop OMs using the DLMtool [@carruthers2018] and MSEtool packages [@huynh_msetool_2019], implemented in the statistical software R [@r2019].
